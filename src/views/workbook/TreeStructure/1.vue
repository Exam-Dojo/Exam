<template>
  <div class="tree-structure-page">
    ...
    <div class="question-image">
      <img src="@/assets/tree-structure/tree-structure1.png" alt="問1の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/tree-structure/tree-structure1answer.png" alt="問1の解説文画像" />
      </div>
