<template>
  <div class="tree-structure-page">
    ...
    <div class="question-image">
      <img src="@/assets/tree-structure/tree-structure3.png" alt="問3の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/tree-structure/tree-structure3answer.png" alt="問3の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/tree-structure2">
...
export default {
  name: 'tree-structurePage3',
  components: { StatusPopup },
  props: ['statusMap'],
  data() {
    return {
      selected: null,
      correctAnswer: 'ア', // ★ 必要に応じて正答を変更
      isCorrect: null,
