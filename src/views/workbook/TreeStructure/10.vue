<template>
  <div class="tree-structure-page">
    ...
    <div class="question-image">
      <img src="@/assets/tree-structure/tree-structure10.png" alt="問10の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/tree-structure/tree-structure10answer.png" alt="問10の解説文画像" />
      </div>
...
export default {
  name: 'tree-structurePage10',
  components: { StatusPopup },
  props: ['statusMap'],
  data() {
    return {
      selected: null,
      correctAnswer: 'ウ', // ★ 必要に応じて正答を変更してください
      isCorrect: null,
