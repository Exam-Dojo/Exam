<template>
  <div class="tree-structure-page">
    ...
    <div class="question-image">
      <img src="@/assets/tree-structure/tree-structure5.png" alt="問5の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/tree-structure/tree-structure5answer.png" alt="問5の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/tree-structure4">
        <button class="nav-button">◀ 前の問題</button>
      </router-link>
      <router-link to="/workbook/tree-structure6">
...
export default {
  name: 'tree-structurePage5',
  components: { StatusPopup },
  props: ['statusMap'],
  data() {
    return {
      selected: null,
      correctAnswer: 'ウ', // ← 必要に応じて正解を設定
      isCorrect: null,
