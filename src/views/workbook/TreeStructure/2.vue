<template>
  <div class="tree-structure-page">
    ...
    <div class="question-image">
      <img src="@/assets/tree-structure/tree-structure2.png" alt="問2の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/tree-structure/tree-structure2answer.png" alt="問2の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/tree-structure1">
