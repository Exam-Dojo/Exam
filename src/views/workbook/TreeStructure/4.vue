<template>
  <div class="tree-structure-page">
    ...
    <div class="question-image">
      <img src="@/assets/tree-structure/tree-structure4.png" alt="問4の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/tree-structure/tree-structure4answer.png" alt="問4の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/tree-structure3">
        <button class="nav-button">◀ 前の問題</button>
      </router-link>
      <router-link to="/workbook/tree-structure5">
...
export default {
  name: 'tree-structurePage4',
  components: { StatusPopup },
  props: ['statusMap'],
  data() {
    return {
      selected: null,
      correctAnswer: 'ア', // ← ★ 正答は適宜変更してください
      isCorrect: null,
