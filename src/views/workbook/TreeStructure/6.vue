<template>
  <div class="tree-structure-page">
    ...
    <div class="question-image">
      <img src="@/assets/tree-structure/tree-structure6.png" alt="問6の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/tree-structure/tree-structure6answer.png" alt="問6の解説文画像" />
      </div>
