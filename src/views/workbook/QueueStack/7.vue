<template>
  <div class="queuestack-page">
    ...
    <div class="question-image">
      <img src="@/assets/queuestack/queuestack7.png" alt="問7の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/queuestack/queuestack7answer.png" alt="問7の解説文画像" />
      </div>
    ...
    <div class="navigation">
      ...
      <router-link to="/workbook/queue-stack8">
...
export default {
  name: 'queuestackPage7',
  components: { StatusPopup },
  props: ['statusMap'],
  data() {
    return {
      selected: null,
      correctAnswer: 'ア', // ★ 正解をここで設定
      isCorrect: null,
