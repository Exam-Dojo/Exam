<template>
  <div class="queuestack-page">
    ...
    <div class="question-image">
      <img src="@/assets/queuestack/queuestack10.png" alt="問10の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/queuestack/queuestack10answer.png" alt="問10の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/queue-stack9">
