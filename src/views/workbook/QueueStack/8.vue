<template>
  <div class="queuestack-page">
    ...
    <div class="question-image">
      <img src="@/assets/queuestack/queuestack8.png" alt="問8の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/queuestack/queuestack8answer.png" alt="問8の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/queue-stack7">
...
export default {
  name: 'queuestackPage8',
  components: { StatusPopup },
  props: ['statusMap'],
  data() {
    return {
      selected: null,
      correctAnswer: 'イ', // ★ 正解をここで設定
      isCorrect: null,
