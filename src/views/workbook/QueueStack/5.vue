<template>
  <div class="queuestack-page">
    ...
    <div class="question-image">
      <img src="@/assets/queuestack/queuestack5.png" alt="問5の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/queuestack/queuestack5answer.png" alt="問5の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/queue-stack4">
        <button class="nav-button">◀ 前の問題</button>
      </router-link>
      <router-link to="/workbook/queue-stack6">
...
export default {
  name: 'queuestackPage5',
  components: { StatusPopup },
  props: ['statusMap'],
  data() {
    return {
      selected: null,
      correctAnswer: 'ア', // ★ 必要に応じて正答を設定
      isCorrect: null,
