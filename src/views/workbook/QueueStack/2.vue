<template>
  <div class="queuestack-page">
    ...
    <div class="question-image">
      <img src="@/assets/queuestack/queuestack2.png" alt="問2の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/queuestack/queuestack2answer.png" alt="問2の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/queue-stack1">
