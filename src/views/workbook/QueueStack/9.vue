<template>
  <div class="queuestack-page">
    ...
    <div class="question-image">
      <img src="@/assets/queuestack/queuestack9.png" alt="問9の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/queuestack/queuestack9answer.png" alt="問9の解説文画像" />
      </div>
    ...
    <div class="navigation">
      ...
      <router-link to="/workbook/queue-stack10">
...
export default {
  name: 'queuestackPage9',
  components: { StatusPopup },
  props: ['statusMap'],
  data() {
    return {
      selected: null,
      correctAnswer: 'イ', // ★ 正解を指定
      isCorrect: null,
