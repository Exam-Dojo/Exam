<template>
  <div class="queuestack-page">
    ...
    <div class="question-image">
      <img src="@/assets/queuestack/queuestack6.png" alt="問6の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/queuestack/queuestack6answer.png" alt="問6の解説文画像" />
      </div>
...
export default {
  name: 'queuestackPage6',
  components: { StatusPopup },
  props: ['statusMap'],
  data() {
    return {
      selected: null,
      correctAnswer: 'イ', // ★ 適切に設定してください
      isCorrect: null,
