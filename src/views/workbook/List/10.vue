<template>
  <div class="list-page">
    ...
    <div class="question-image">
      <img src="@/assets/list/list10.png" alt="問10の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/list/list10answer.png" alt="問10の解説文画像" />
      </div>
