<template>
  <div class="grammer-page">
    ...
    <div class="question-image">
      <img src="@/assets/grammer/grammer7.png" alt="問7の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/grammer/grammer7answer.png" alt="問7の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/grammar6">
        <button class="nav-button">◀ 前の問題</button>
      </router-link>
      <router-link to="/workbook/grammar8">
