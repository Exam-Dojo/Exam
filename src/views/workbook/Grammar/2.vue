<template>
  <div class="grammer-page">
    ...
    <div class="question-image">
      <img src="@/assets/grammer/grammer2.png" alt="問2の問題文画像" />
    </div>
    ...
    <div class="buttons">
      ...
      <button :disabled="selected" @click="selectAnswer('オ')">オ</button>
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/grammer/grammer2answer.png" alt="問2の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/grammar1">
        <button class="nav-button">◀ 前の問題</button>
      </router-link>
      <router-link to="/workbook/grammar3">
