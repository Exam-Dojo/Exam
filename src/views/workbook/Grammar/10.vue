<template>
  <div class="grammer-page">
    ...
    <div class="question-image">
      <img src="@/assets/grammer/grammer10.png" alt="問9の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/grammer/grammer10answer.png" alt="問9の解説文画像" />
      </div>
      <button class="reset-button" @click="resetSelection">やり直す</button>
    </div>

    <div class="navigation">
      <router-link to="/workbook/grammar9">
...
export default {
  ...
  methods: {
    ...
    confirmAndFinish() {
      ...
      if (ok) {
        sessionStorage.removeItem('statusMap') // 状況をリセット
        this.$router.push('/workbook') // トップページに遷移
      }
    },
  },
}
