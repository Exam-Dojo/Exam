<template>
  <div class="recursion-page">
    ...
    <div class="question-image">
      <img src="@/assets/recursion/recursion4.png" alt="問4の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/recursion/recursion4answer.png" alt="問4の解説文画像" />
      </div>
      <button class="reset-button" @click="resetSelection">やり直す</button>
    </div>

    <div class="navigation">
      <router-link to="/workbook/recursion3">
        <button class="nav-button">◀ 前の問題</button>
      </router-link>
      <router-link to="/workbook/recursion5">
