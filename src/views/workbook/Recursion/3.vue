<template>
  <div class="recursion-page">
    ...
    <div class="question-image">
      <img src="@/assets/recursion/recursion3.png" alt="問3の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/recursion/recursion3answer.png" alt="問3の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/recursion2">
