<template>
  <div class="recursion-page">
    ...
    <div class="question-image">
      <img src="@/assets/recursion/recursion8.png" alt="問8の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/recursion/recursion8answer.png" alt="問8の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/recursion7">
