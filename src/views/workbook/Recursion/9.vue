<template>
  <div class="recursion-page">
    ...
    <div class="question-image">
      <img src="@/assets/recursion/recursion9.png" alt="問9の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/recursion/recursion9answer.png" alt="問9の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/recursion8">
        <button class="nav-button">◀ 前の問題</button>
      </router-link>
      <router-link to="/workbook/recursion10">
