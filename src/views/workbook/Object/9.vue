<template>
  <div class="object-page">
    ...
    <div class="question-image">
      <img src="@/assets/object/object9.png" alt="問9の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/object/object9answer.png" alt="問9の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/object8">
        <button class="nav-button">◀ 前の問題</button>
      </router-link>
      <router-link to="/workbook/object10">
