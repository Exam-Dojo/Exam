<template>
  <div class="object-page">
    ...
    <div class="question-image">
      <img src="@/assets/object/object4.png" alt="問4の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/object/object4answer.png" alt="問4の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/object3">
        <button class="nav-button">◀ 前の問題</button>
      </router-link>
      <router-link to="/workbook/object5">
