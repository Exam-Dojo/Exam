<template>
  <div class="object-page">
    ...
    <div class="question-image">
      <img src="@/assets/object/object5.png" alt="問5の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/object/object5answer.png" alt="問5の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/object4">
        <button class="nav-button">◀ 前の問題</button>
      </router-link>
      <router-link to="/workbook/object6">
