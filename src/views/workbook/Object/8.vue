<template>
  <div class="object-page">
    ...
    <div class="question-image">
      <img src="@/assets/object/object8.png" alt="問8の問題文画像" />
    </div>
    ...
    <div class="explanation" v-if="selected" ref="explanation">
      <div class="question-image">
        <img src="@/assets/object/object8answer.png" alt="問8の解説文画像" />
      </div>
    ...
    <div class="navigation">
      <router-link to="/workbook/object7">
...
export default {
  ...
  data() {
    return {
      selected: null,
      correctAnswer: 'イ', // ★ ここは実際の答えに応じて変更
      isCorrect: null,
